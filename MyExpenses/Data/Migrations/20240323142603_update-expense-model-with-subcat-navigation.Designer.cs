...
namespace MyExpenses.Migrations
{
    ...
    [Migration("20240323142603_update-expense-model-with-subcat-navigation")]
    partial class updateexpensemodelwithsubcatnavigation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyExpenses.Domain.Expense", b =>
                {
                    b.HasOne("MyExpenses.Domain.SubCat", "SubCat")
                        .WithMany()
            ...
            modelBuilder.Entity("MyExpenses.Domain.SubCat", b =>
                {
                    b.HasOne("MyExpenses.Domain.Category", "Category")
                        .WithMany("SubCats")
                        .HasForeignKey("CatId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
